...
describe('htmlready', () => {
    ...
    it('should allow links where the text portion and href contains next.vox.community', () => {
        const dirty =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/signup" xmlns="http://www.w3.org/1999/xhtml">https://next.vox.community/signup</a></xml>';
    ...
    it('should not allow links where the text portion contains next.vox.community but the link does not', () => {
        ...
        const dirty =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/signup" xmlns="http://www.w3.org/1999/xhtml">https://next.vox.community/signup</a></xml>';
        const cleansed =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><div title="missing translation: en.g.phishy_message" class="phishy">https://next.vox.community/signup / https://next.vox.community/signup</div></xml>';
        const res = HtmlReady(dirty).html;
        ...
        const withuser =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/signup" xmlns="http://www.w3.org/1999/xhtml">https://official@next.vox.community/signup</a></xml>';
        const cleansedwithuser =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><div title="missing translation: en.g.phishy_message" class="phishy">https://official@next.vox.community/signup / https://next.vox.community/signup</div></xml>';
        const reswithuser = HtmlReady(withuser).html;
        expect(reswithuser).toEqual(cleansedwithuser);

        const noendingslash =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community" xmlns="http://www.w3.org/1999/xhtml">https://next.vox.community</a></xml>';
        const cleansednoendingslash =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><div title="missing translation: en.g.phishy_message" class="phishy">https://next.vox.community / https://next.vox.community</div></xml>';
        ...
        const domainInpage =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community#really-evil-inpage-component" xmlns="http://www.w3.org/1999/xhtml">https://next.vox.community</a></xml>';
        const cleanDomainInpage =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><div title="missing translation: en.g.phishy_message" class="phishy">https://next.vox.community / https://next.vox.community#really-evil-inpage-component</div></xml>';
        const resDomainInpage = HtmlReady(domainInpage).html;
        expect(resDomainInpage).toEqual(cleanDomainInpage);

        // anchor links including next.vox.community should be allowed
        const inpage =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="#https://next.vox.community/unlikelyinpagelink" xmlns="http://www.w3.org/1999/xhtml">Go down lower for https://next.vox.community info!</a></xml>';
        const cleanInpage =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="#https://next.vox.community/unlikelyinpagelink" xmlns="http://www.w3.org/1999/xhtml">Go down lower for https://next.vox.community info!</a></xml>';
        ...
        const noprotocol =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/" xmlns="http://www.w3.org/1999/xhtml">for a good time, visit next.vox.community today</a></xml>';
        const cleansednoprotocol =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><div title="missing translation: en.g.phishy_message" class="phishy">for a good time, visit next.vox.community today / https://next.vox.community/</div></xml>';
    ...
    it('should not link usernames at the front of linked text', () => {
        const nameinsidelinkfirst =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/signup">@hihi</a></xml>';
        const htmlified =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/signup">@hihi</a></xml>';
    ...
    it('should not link usernames in the middle of linked text', () => {
        const nameinsidelinkmiddle =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/signup">hi @hihi</a></xml>';
        const htmlified =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://next.vox.community/signup">hi @hihi</a></xml>';
    ...
    it('should not mistake usernames in valid comment urls as mentions', () => {
        const url =
            'https://next.vox.community/spam/@test-safari/34gfex-december-spam#@test-safari/re-test-safari-34gfex-december-spam-20180110t234627522z';
    ...
    it('should detect urls that are phishy', () => {
        const dirty =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><a href="https://steewit.com/signup" xmlns="http://www.w3.org/1999/xhtml">https://next.vox.community/signup</a></xml>';
        const cleansed =
            '<xml xmlns="http://www.w3.org/1999/xhtml"><div title="missing translation: en.g.phishy_message" class="phishy">https://next.vox.community/signup / https://steewit.com/signup</div></xml>';
        const res = HtmlReady(dirty).html;
        expect(res).toEqual(cleansed);
    });
