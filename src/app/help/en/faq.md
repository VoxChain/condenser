...
- <a href="#What_is_Steemit_com">What is Vox.community?</a>
- <a href="#How_does_Steemit_work">How does Vox work?</a>
- <a href="#How_does_Steemit_differ_from_other_social_media_websites">How does Vox differ from other social media websites?</a>
- <a href="#Does_it_cost_anything_to_post__comment__or_vote">Does it cost anything to post, comment, or vote?</a>
- <a href="#Can_I_earn_digital_tokens_on_Steemit_How">Can I earn digital tokens on Vox? How?</a>
...
- <a href="#Can_I_create_a_Steem_account_without_an_email_and_phone_number">Can I create a VoxChain account without an email and phone number?</a>
- <a href="#What_are_other_ways_to_create_an_account_on_the_blockchain_besides_using_Steemit_com">What are other ways to create an account on the blockchain besides using Vox.community?</a>
...
- <a href="#Is_there_an_Etiquette_Guide_for_Steemit">Is there an Etiquette Guide for Vox?</a>
...
- <a href="#How_do_I_transfer_my_STEEM_or_Steem_Dollars_into_savings">How do I transfer my STEEM or VoxChain Dollars into savings?</a>
...
- <a href="#What_can_users_post_to_Steemit">What can users post to Vox?</a>
...
- <a href="#What_is_the_difference_between_STEEM__STEEM_Power__and_Steem_Dollars">What is the difference between STEEM, STEEM Power, and VoxChain Dollars?</a>
...
- <a href="#Will_1_Steem_Dollar_always_be_worth__1_00_USD">Will 1 VoxChain Dollar always be worth $1.00 USD?</a>
- <a href="#How_do_Steem_Dollar_to_STEEM_conversions_work">How do VoxChain Dollar to STEEM conversions work?</a>
- <a href="#Is_there_a_way_for_me_to_convert_my_Steem_Dollars_to_STEEM_without_waiting_3_5_days">Is there a way for me to convert my VoxChain Dollars to STEEM without waiting 3.5 days?</a>
...
- <a href="#Can_I_sell_goods_and_services_on_Steemit">Can I sell goods and services on Vox?</a>
- <a href="#How_can_I_withdraw_my_STEEM_or_SBD_coins">How can I withdraw my STEEM or SBD coins?</a>
- <a href="#Will_I_get_a_1099_from_Steemit">Will I get a 1099 from Vox?</a>
...
- <a href="#What_are_Steemit_s_policies_on_plagiarism">What are Vox’s policies on plagiarism?</a>
...
- <a href="#What_is_the_Steem_blockchain">What is the VoxChain blockchain?</a>
- <a href="#What_is_the_difference_between_Steem_and_Steemit">What is the difference between VoxChain and Vox?</a>
- <a href="#How_is_Steem_different_from_Bitcoin">How is VoxChain different from Bitcoin?</a>
...
- <a href="#How_often_does_the_Steem_blockchain_produce_a_new_block">How often does the VoxChain blockchain produce a new block?</a>
...
### <span id="Table_of_Contents_Steemit__Inc">Vox, Inc.</span>
- <a href="#Who_is_the_CEO_of_Steemit">Who is the CEO of Vox?</a>
- <a href="#Can_I_invest_in_Steemit">Can I invest in Vox?</a>
- <a href="#What_does_Steemit_s_development_roadmap_look_like">What does Vox’s development roadmap look like?</a>
- <a href="#Am_I_allowed_to_use_the_Steem_and_Steemit_logos">Am I allowed to use the VoxChain and Vox logos?</a>
- <a href="#Can_I_purchase_official_Steemit_merchandise">Can I purchase official Vox merchandise?</a>
- <a href="#Did_Steemit__pre_mine__tokens">Did Vox "pre-mine" tokens?</a>
- <a href="#What_is_the_Steemit_Privacy_Policy">What is the Vox Privacy Policy?</a>

### <span id="Table_of_Contents_Security">Security</span>
- <a href="#How_can_I_keep_my_Steem_account_secure">How can I keep my VoxChain account secure?</a>
...
- <a href="#Are_my_STEEM_and_Steem_Dollar_tokens_insured_in_the_event_of_a_hack_or_if_someone_takes_over_my_account">Are my STEEM and VoxChain Dollar tokens insured in the event of a hack or if someone takes over my account?</a>
...
- <a href="#Are_the_Steem_blockchain_and_Steemit_com_code_open_source">Are the VoxChain blockchain and Vox.community code open-source?</a>
- <a href="#Is_there_a_Github_page_for_Steemit_com">Is there a Github page for Vox.community?</a>
- <a href="#Is_there_a_Github_page_for_the_Steem_blockchain">Is there a Github page for the VoxChain blockchain?</a>
- <a href="#What_is_available_for_developers_interested_in_Steem_and_Steemit">What is available for developers interested in VoxChain and Vox?</a>
- <a href="#How_do_I_use_cli_wallet">How do I use cli_wallet?</a>

### <span id="Table_of_Contents_Witnesses">Witnesses</span>
- <a href="#What_are_Steem_witnesses">What are VoxChain witnesses?</a>
...
- <a href="#What_third_party_tools_are_there_for_Steemit">What third-party tools are there for Vox?</a>
- <a href="#Is_there_an_official_Steemit_Facebook_page">Is there an official Vox Facebook page?</a>
- <a href="#Is_there_an_official_Steemit_Twitter_account">Is there an official Vox Twitter account?</a>
- <a href="#What_is_the_Steem_Whitepaper_and_what_is_its_purpose">What is the VoxChain Whitepaper and what is its purpose?</a>
...
## <span id="What_is_Steemit_com">What is Vox.community?</span>

Vox is a social network and content rewards platform that makes the crowd the beneficiaries of the attention economy. It does this be rewarding users with STEEM.

Vox has redefined social media by building a living, breathing, and growing social economy; a community where users are getting rewarded for sharing their voice.

<a href="#Table_of_Contents_General">^</a>
## <span id="How_does_Steemit_work">How does Vox work?</span>

Vox is a social media platform that works by having the crowd reward the crowd for their content. It does this thanks to the VoxChain blockchain and cryptocurrency; VoxChain is 'minted' daily and distributed to content producers according to the votes they get.
...
## How does Vox differ from other social media websites? <a id="How_does_Steemit_differ_from_other_social_media_websites"></a>

Most social media sites extract value from their userbase for the benefit of shareholders alone. Vox is different, it's a new kind of attention economy. By connecting with the VoxChain blockchain (which is decentralized and controlled by the crowd), Vox users receive all the benefits and rewards for their attention.

<a href="#Table_of_Contents_General">^</a>
## <span id="Does_it_cost_anything_to_post__comment__or_vote">Does it cost anything to post, comment, or vote?</span>

No. It is free to post, comment, and vote on content on Vox.community. You might even get paid for it!

<a href="#Table_of_Contents_General">^</a>
## <span id="Can_I_earn_digital_tokens_on_Steemit_How">Can I earn digital tokens on Vox? How?</span>

You can earn digital tokens on Vox by:

**Posting** - By sharing your posts, you can earn upvotes from community members. Depending on the upvotes you receive, you will get a portion of the ongoing VoxChain reward pool.
...
**Purchasing** - Users can purchase STEEM or VoxChain Dollar tokens directly through the Vox wallet using bitcoin, Ether, or BitShares tokens. They are also available from other markets and exchanges including BlockTrades, Poloniex, Bittrex, Shapeshift.io, and Changelly. STEEM tokens that are powered up to STEEM Power earn a small amount of interest for holding.

<a href="#Table_of_Contents_General">^</a>
## <span id="Where_do_the_tokens_come_from">Where do the tokens come from?</span>

The VoxChain network continually creates digital tokens to reward content creators and curators. Some of the newly-created tokens are transferred to users who add value to Vox by posting, commenting, and voting on other people's posts. The remainder is distributed to holders of STEEM Power and the witnesses that power the blockchain.

<a href="#Table_of_Contents_General">^</a>
## <span id="Where_does_the_value_come_from">Where does the value come from?</span>

At its root, VoxChain is simply a points system. However, because this points system is blockchain-based, the points can be traded on markets as tokens. People buy and sell these tokens, and many hold in anticipation of increased purchasing power for various VoxChain-related services.

By analogy, VoxChain is a game system where users compete for attention and rewards by bringing content and adding value to the platform. The rewards people earn are tokens that have market value and are readily tradable. It is similar to how someone playing a video game could obtain a limited item or currency by playing the game. If the currency or items are transferable between users, then they can sell or buy them on game item markets.

<a href="#Table_of_Contents_General">^</a>
## <span id="Why_are_people_getting_vastly_different_rewards">Why are people getting vastly different rewards?</span>

Vox is not a "get rich quick" scheme. While it is possible to post content that goes viral quickly and earn a lot of rewards on a single post, this is not typical for most users.
...
Click on the "Sign Up" link at the top of Vox.community to get started.
...
To create an account on the blockchain, it costs STEEM tokens. When you create an account through Vox.community, Vox Inc. is supplying the tokens to pay the account creation fee. In order to prevent users from abusing the paid-for signup and creating multiple accounts, we need to be able to verify that each user is only signing up for one account.

<a href="#Table_of_Contents_Accounts">^</a>
## <span id="Can_I_create_a_Steem_account_without_an_email_and_phone_number">Can I create a VoxChain account without an email and phone number?</span>

The only way to have an account created via Vox.community is to supply your email and phone number. Because VoxChain is an open and permissionless network, there are other ways to create a VoxChain account. Any VoxChain blockchain account can be used on Vox.community

<a href="#Table_of_Contents_Accounts">^</a>
## <span id="What_are_other_ways_to_create_an_account_on_the_blockchain_besides_using_Steemit_com">What are other ways to create an account on the blockchain besides using Vox.community?</span>

If you are willing to pay your own signup fee, then there are other ways to create a new account on the blockchain.

There is a third-party tool called <a href="https://www.SteemCreate.com">SteemCreate</a> that accepts credit cards, or BTC to create a VoxChain account. You do not need to have an existing VoxChain blockchain account to use the service, but there is a charge on top of the blockchain account creation fee for using the service.

There is a third-party tool called <a href="https://steemit.com/steemit/@someguy123/anonsteem-create-anonymous-steem-accounts-without-social-media">AnonSteem</a> that accepts bitcoin, Litecoin, STEEM, or SBD to anonymously create a VoxChain account. You do not need to have an existing VoxChain blockchain account to use the service, but there is a charge on top of the blockchain account creation fee for using the service.

There is a third-party tool called <a href="https://steemit.com/news/@timcliff/new-tool-from-busy-org-create-new-steem-blockchain-accounts-with-steemconnect">SteemConnect</a> that allows you to create accounts by paying or delegating the account creation fee. There is no additional fee to use the service, but does require an existing VoxChain blockchain account to pay the account creation fee to create the account.

There is a third-party tool called <a href="https://steemit.com/blocktrades/@blocktrades/buy-steem-accounts-with-pre-loaded-steem-from-blocktrades">BlockTrades</a> that accepts bitcoin, Litecoin, STEEM, SBD, BitShares, Dash, Dogecoin, Ethereum, and more to create a VoxChain account. You can also send extra tokens to pre-load the account with additional VoxChain Power. You do not need to have an existing VoxChain blockchain account to use the service, but there is a charge on top of the blockchain account creation fee for using the service.
...
Each user is allowed only one paid-for account created via Vox.community, however users are allowed to create multiple accounts on the blockchain. Creating additional accounts on the blockchain requires users to pay their own account creation fee for any additional accounts.
...
## <span id="Is_there_an_Etiquette_Guide_for_Steemit">Is there an Etiquette Guide for Vox?</span>

There are no official rules for participating on Vox.community, but one of the users @thecryptofiend has created an <a href="https://steemit.com/steemit/@thecryptofiend/the-complete-steemit-etiquette-guide-revision-2-0">Etiquette Guide</a> for the community. While it is not required to follow the suggestions in the guide, they are standards that many users in the community choose to follow.
...
There are a number of ways to do this. The most common way to verify your identity is by posting a link to your Vox profile on a website or social media account which you are already known for having such as Twitter, Facebook, LinkedIn, a blog, or photography site.

Many users also like to post a photo or a video which shows them holding up a sheet of paper with the current date and their VoxChain account name handwritten on it. This is a great way to add a personal touch to verifying.
...
These are various ways to sort VoxChain posts.
...
**Promoted** - Listings that are boosted by VoxChain Dollar payments get promoted for greater visibility.

<a href="#Table_of_Contents_Site_Navigation">^</a>
## <span id="What_information_is_available_in_my_account_menu">What information is available in my account menu?</span>

You can get to your account menu by clicking on the avatar icon in the top-right corner of a Vox.community page. 
...
**Wallet** - Here is where you go to see your wallet balances, make transfers, exchange STEEM or VoxChain Dollars, and Power Up.
...
Your wallet shows how many STEEM and VoxChain Dollar tokens you have in your account. It shows how much STEEM Power it has, and how much SP is delegated. It also shows how many of your STEEM and VoxChain Dollar tokens are being held in the savings account, which is a balance that is subject to 3 day withdraw waiting period. The wallet page shows any the progress of any VoxChain Dollar to STEEM conversions as well as the status of a power down. It also shows an estimated value of all the tokens in your account, based on the recent market prices of STEEM and SBD.

<a href="#Table_of_Contents_Site_Navigation">^</a>
## <span id="How_do_I_transfer_my_STEEM_or_Steem_Dollars_into_savings">How do I transfer my STEEM or VoxChain Dollars into savings?</span>
...
- From your wallet page, click the STEEM or VoxChain Dollar balances with the down arrow next to them.
- In the drop-down menu, click 'Transfer'. 
- Type the username of the account you want to send the STEEM or VoxChain Dollars to. Double and triple check spelling.
- Enter the amount of STEEM or VoxChain Dollars to send.
...
Vox also allows you to subscribe to receive additional notifications when users mention you in a comment or post.

Currently, there are no options to receive notifications for votes directly on Vox.community. But, there is a third-party application https://steemstats.com/, developed by @jesta, which has an option to set up additional notifications on your computer.
...
Your profile info, avatar image, and cover image are set in your Settings page. In order to update your avatar picture and cover image, you will need to host the images somewhere. This can be done by uploading it to a Vox comment or post, or using a third-party image host such as <a href="http://postimage.io/">Postimage</a>.  Once your image is uploaded, copy its URL and paste it into the "Profile Picture URL" box for the avatar, or the "Cover Image URL" box for the cover image. Then click the Update button and enter your password or active key.
...
In the upper right corner of Vox, there is a magnifying glass search link where you can find posts using a keyword search.
...
No. This information is not presented on Vox.community.
...
English is the most-used language used on the Vox platform, but communities are forming that speak other languages.

<a href="#Table_of_Contents_Site_Navigation">^</a>
# Posting

## <span id="What_can_users_post_to_Steemit">What can users post to Vox?</span>

VoxChain is an open platform meant to host and welcome any legal content. Users can post anything they want, whether it be phrases, quotes, blogs, anecdotes, photos, videos, memes, songs, and more. Be creative!
...
- **50%/50%** - This rewards in half STEEM Power, and half liquid STEEM / VoxChain Dollars. The ratio of liquid STEEM to VoxChain Dollars rewarded is based on network conditions at the time of payout. This is the default payout option.

- **Power Up 100%** - This option rewards the post in 100% Steem Power.

- **Decline Payout** - Use this option to receive no post rewards. Votes will affect the post's position on the trending ranking but no rewards are paid from VoxChain's reward pool. Replies made to the post are still eligible for rewards.
...
Yes, but the picture must be resized before it is uploaded into the Vox.community editor. This can be done in your favorite photo editing software, or online by uploading to a third-party website that features editing such as imgur.com.
...
The blockchain will always contain the full edit history of posts and comments, so it can never be completely deleted. If you would like to update a post so that users cannot see the content via Vox.community, you can edit the post and replace it with blank content for as long as the post is active. After seven days, the post can no longer be edited.

<a href="#Table_of_Contents_Posting">^</a>
## <span id="What_does__Promoting__a_post_do">What does "Promoting" a post do?</span>

When you make a post, there is the option to promote it with VoxChain Dollars. It will then show up in the “Promoted” tab. The order that it appears in the list depends on how much the post was promoted for. Posts with a higher promoted amount will be higher than posts with less.

VoxChain Dollars spent to promote a post are paid to the account @null, which nobody owns or controls. Once a user transfers SBD to @null, the VoxChain blockchain removes them from the currency supply. Details can be found in this <a href="https://steemit.com/steemit/@steemitblog/introducing-promoted-content">official post</a>.
...
At the bottom of each post is a button to "Promote". After clicking the button, type the number of VoxChain Dollars that you want to spend and click “PROMOTE”. The operation will require your master password or active key.
...
Blockchains like VoxChain and Bitcoin produce new tokens each time a block is produced. Unlike Bitcoin, where all of the new coins go to the block producers (called miners), the VoxChain blockchain allocates a majority of the new tokens to a reward fund. The reward fund gives users tokens for participating in the platform.
...
Votes in VoxChain are stake-weighted. Therefore voters with more STEEM Power have a greater influence over the allocation than voters with less SP, but their votes do not increase the amount of rewards.
...
<a href="#Table_of_Contents_Economics">^</a>
## <span id="What_is_the_difference_between_STEEM__STEEM_Power__and_Steem_Dollars">What is the difference between STEEM, STEEM Power, and VoxChain Dollars?</span>

**STEEM** - STEEM is the base liquid currency token in the platform. STEEM can be powered up into STEEM Power, traded for VoxChain Dollars, and transferred to other accounts. It is a cryptocurrency token, similar to bitcoin.

**STEEM Power** - STEEM Power (abbreviated SP) is a measurement of how much influence a user has in the VoxChain network. The more STEEM Power a user holds, the more they can influence the value of posts and comments. STEEM Power is less liquid. If a user wishes to “Power Down” SP, they will receive equal distributions of the STEEM weekly, over a 13 week period.

**VoxChain Dollars** - VoxChain Dollars (commonly abbreviated SBD) are liquid stable-value currency tokens designed to be pegged to $1 USD. VoxChain Dollars can be traded with STEEM, and transferred to other accounts for commerce or exchange.  VoxChain Dollars may also be converted into STEEM in a process that takes 3.5 days. VoxChain Dollars can be used to buy things in marketplaces, such as PeerHub.com.
...
Most users will have a small amount of STEEM Power delegated to them by the Vox account after creating an account via Vox.community.
...
With STEEM tokens in your wallet, click "Power Up" to turn them into STEEM Power. If you have VoxChain Dollars, you can convert them to STEEM from your wallet, and then power up the STEEM.

If you don’t already have STEEM or VoxChain Dollars in your wallet, you can purchase them using bitcoin (BTC), ether (ETH), or BitShares (BTS) tokens. You may purchase BTC on various exchanges, such as Coinbase.com or Localbitcoins.com. 

To buy:
- Click "Buy VoxChain" from the main menu in the top right corner of Vox.community, or from your wallet.
- Select the currency to deposit, and enter the amount of that currency you wish to use.
- Enter your Vox account name (without the @) for "Your receive address".
- Click the "Get Deposit Address" button.
- Send the currency to the provided address.

STEEM purchases made via Vox.community are facilitated by <a href="https://blocktrades.us">BlockTrades</a>.
...
Transactions on the VoxChain blockchain typically only take about three seconds to process, but when you are purchasing the STEEM tokens using bitcoin or some other token, then the transaction must wait for the transaction to be confirmed on the other network. This can often take several hours, and sometimes even days.    
...
**Powering up** - If you have STEEM tokens, you can Power Up to STEEM Power to get more voting influence on posts and comments. Having more STEEM Power also increases the amount of curation rewards and interest that you can earn. More SP also grants more influence on approving VoxChain witnesses.
...
Payouts occur as a combination of STEEM Power and VoxChain Dollars. Sometimes the blockchain may substitute STEEM in place of the VoxChain Dollars based on market conditions.

The blockchain estimates the dollar value of STEEM and STEEM Power based on the 3.5 day average price of STEEM reported by the witnesses. The blockchain assumes VoxChain Dollars are worth approximately one USD.

<a href="#Table_of_Contents_Economics">^</a>
## <span id="Will_1_Steem_Dollar_always_be_worth__1_00_USD">Will 1 VoxChain Dollar always be worth $1.00 USD?</span>

The market value of a VoxChain Dollar is dictated by the supply and demand of the token. Therefore it is possible for 1 SBD to be worth more or less than 1 USD depending on market conditions. However, the network's SBD conversion feature serves as a mechanism to hold VoxChain Dollars within a small margin of the value of USD.

<a href="#Table_of_Contents_Economics">^</a>
## <span id="How_do_Steem_Dollar_to_STEEM_conversions_work">How do VoxChain Dollar to STEEM conversions work?</span>

If you convert VoxChain Dollars to STEEM on the Wallet page, the blockchain will process the transaction over a period of 3.5 days. At the end of the 3.5 days, the SBD will be gone and replaced by approximately $1 USD worth of STEEM tokens. The "approximately 1 USD worth of STEEM tokens" is based on the median STEEM price over the 3.5 days, using the price feeds from the VoxChain witnesses. Depending on price fluctuations during the 3.5 days it is possible to end up with more or less than $1 USD worth of STEEM per SBD at the end of the conversion.

<a href="#Table_of_Contents_Economics">^</a>
## <span id="Is_there_a_way_for_me_to_convert_my_Steem_Dollars_to_STEEM_without_waiting_3_5_days">Is there a way for me to convert my VoxChain Dollars to STEEM without waiting 3.5 days?</span>
...
<a href="#Table_of_Contents_Economics">^</a>
## <span id="Can_I_sell_goods_and_services_on_Steemit">Can I sell goods and services on Vox?</span>

Other than making a post and making sales manually, there is no interface for selling items directly on Vox.community. You can list goods on the third-party website <a href="https://www.peerhub.com">PeerHub.com</a>. Through PeerHub, you can accept payment in VoxChain Dollars or STEEM, and you have the option to advertise your items through Vox posts.
...
<a href="#Table_of_Contents_Economics">^</a>
## <span id="Will_I_get_a_1099_from_Steemit">Will I get a 1099 from Vox?</span>

No, you are not being paid by Vox. The VoxChain network rewards you. It is your responsibility to determine what, if any, taxes apply to the transactions you make. Further, it is your responsibility to report and remit the correct tax to the appropriate tax authority. By creating an account, you agree that Vox Inc is not responsible for determining whether taxes apply to your VoxChain transactions or for collecting, reporting, withholding, or remitting any taxes arising from any VoxChain transactions.
...
There are never any fees for transfers within the VoxChain network. However, if you transfer VoxChain to an exchange and convert it to another currency, you will incur a small fee from the exchange.
...
The platform does not require that anybody purchase SP in order to participate, and there are many users who have earned a lot of STEEM Power without spending any of their own money. You have the option of purchasing more STEEM Power through your Vox wallet.
...
## <span id="What_are_Steemit_s_policies_on_plagiarism">What are Vox’s policies on plagiarism?</span>
...
Steemcleaners are a group of Steemians concerned with plagiarism, copy/paste, spam, scams and other forms of abuse on Vox. 
...
@cheetah is a bot developed by @anyx that scours Vox for copy/pasted content. Cheetah will not downvote copied content, but it alerts other users to look into it further.
...
Every user has a reputation score next to their name. The reputation score is one way Vox measures the amount of value you have brought to the community. It is also a mechanism that is designed to help reduce abuse of the Vox platform. 
...
Every time another user upvotes one of your posts or comments, it increases your reputation score. Users with a higher reputation than you will have more of a positive effect. The more STEEM Power that the voter has, the larger the effect is as well. The best way to earn upvotes is by adding value to the Vox community.
...
A reputation score is one way Vox measures the amount of value you have brought to the community. In real estate, they say there are three variables of the utmost importance: location, location, location. On Vox, those things are: reputation, reputation, reputation. It’s not to say other variables aren’t important, but reputation will be an enormous factor in your level of success.
...
It is worth noting that if your reputation score goes below 0, Vox will hide your posts and comments making it very difficult to gain monetary rewards and followers. This incentivizes online etiquette and respect for your fellow Steemians.
...
Yes you can use the share button to share on Facebook, Twitter or LinkedIn. You are welcome to post your Vox links on other websites and social media sites.
...
## <span id="What_is_the_Steem_blockchain">What is the VoxChain blockchain?</span>

The VoxChain blockchain is the publicly accessible distributed database, which records all posts and votes, and distributes the rewards across the network. It is where all of the text content and voting data is stored, and it is where all of the reward calculations and payouts are performed.

<a href="#Table_of_Contents_Blockchain">^</a>
## <span id="What_is_the_difference_between_Steem_and_Steemit">What is the difference between VoxChain and Vox?</span>

VoxChain is the name of the blockchain that stores all of the data and transactions, and processes all of the events that take place. STEEM is also a name for the system’s value token (currency).

Vox is a front end web interface to interact with the blockchain, and view the blockchain data.

<a href="#Table_of_Contents_Blockchain">^</a>
## <span id="How_is_Steem_different_from_Bitcoin">How is VoxChain different from Bitcoin?</span>

On a technical level, the two networks rely on the same model of a blockchain, but are built upon different technologies and codebase. VoxChain is based on a new state-of-the-art blockchain technology called Graphene, which uses "witnesses" instead of "miners" to produce blocks. 

The "delegated proof of stake" model of using witnesses instead of miners allows for greater efficiency in block production. With BTC, 100% of the new coins that are created are allocated to block producers (miners). With the VoxChain blockchain, only 10% of the new coins are paid to block producers (witnesses). The other 90% of new STEEM coins are awarded to content producers, curators, and STEEM Power holders.
...
**Delegated proof of stake** - Block-creating accounts, called witnesses, are collectively approved by VoxChain stakeholders. Instead of relying on proof of work to find blocks, the VoxChain network actively schedules these accounts to improve the time between blocks to 3 seconds.

<a href="#Table_of_Contents_Blockchain">^</a>
## <span id="How_often_does_the_Steem_blockchain_produce_a_new_block">How often does the VoxChain blockchain produce a new block?</span>

The VoxChain blockchain schedules witnesses to produce a new block every 3 seconds. 21 witness nodes produce 21 blocks in each 63-second round.
...
The original launch of VoxChain was on March 23, 2016, announced on <a href="https://bitcointalk.org/index.php?topic=1408726.0">Bitcointalk.org</a>. There was a bug found in the original code though, and a majority of the stakeholders agreed that it would be easier to fix via a re-launch than a hardfork. The blockchain was reset and officially re-launched on March 24, 2016, via <a href="https://bitcointalk.org/index.php?topic=1410943.0">Bitcointalk.org</a>.

<a href="#Table_of_Contents_Blockchain">^</a>
## <span id="Can_I_mine_STEEM">Can I mine STEEM?</span>

No. Proof of work mining has been removed from VoxChain.

<a href="#Table_of_Contents_Blockchain">^</a>
# Vox, Inc.

## <span id="Who_is_the_CEO_of_Steemit">Who is the CEO of Vox?</span>

Ned Scott, @ned
https://www.linkedin.com/in/nedscott

<a href="#Table_of_Contents_Steemit__Inc">^</a>
## <span id="Can_I_invest_in_Steemit">Can I invest in Vox?</span>

Vox, Inc. is a privately held company and is not available for public investment.

Though not considered an investment, you can purchase STEEM tokens which can go up or down in value. You can power up these tokens into STEEM Power, which grants more influence in the VoxChain platform.

<a href="#Table_of_Contents_Steemit__Inc">^</a>
## <span id="What_does_Steemit_s_development_roadmap_look_like">What does Vox’s development roadmap look like?</span>

You can view the 2017 Roadmap here:
https://steemit.com/steemit/@steemitblog/steemit-2017-roadmap

<a href="#Table_of_Contents_Steemit__Inc">^</a>
## <span id="Am_I_allowed_to_use_the_Steem_and_Steemit_logos">Am I allowed to use the VoxChain and Vox logos?</span>

The Vox brand and logo are protected by intellectual property laws, including copyright and other proprietary rights of the United States and other countries. The purpose is to allow Vox to protect the brand and logo in ways that extend user safety. One may not make unauthorized commercial use of, reproduce, prepare derivative works, distribute copies, perform, or publicly display the Vox logo or brand, except as permitted by the doctrine of fair use, or as authorized in writing by us.

[Section 107 of the Copyright Act](http://www.copyright.gov/title17/92chap1.html#107) provides the statutory framework for determining whether something is a fair use and identifies certain types of uses—such as criticism, comment, news reporting, teaching, scholarship, and research—as examples of activities that may qualify as fair use. **Vox considers artistic variations of the Vox logo that are used for non-commercial purposes, and are not used to harm Vox users (i.e. through attraction to phishing sites), an instance of fair use.** 

The blue VoxChain logo with the three S-shaped squiggles is licensed under Creative Commons CC0, meaning you’re free to copy, modify, or distribute (even for commercial purposes) without needing to ask permission or give attribution.

<a href="#Table_of_Contents_Steemit__Inc">^</a>
## <span id="Can_I_purchase_official_Steemit_merchandise">Can I purchase official Vox merchandise?</span>

Yes. Official Vox merchandise can be purchased from [The Vox Shop](https://thesteemitshop.com/).

<a href="#Table_of_Contents_Steemit__Inc">^</a>
## <span id="Did_Steemit__pre_mine__tokens">Did Vox "pre-mine" tokens?</span>

The STEEM tokens mined by Vox, Inc. were not "pre-mined". All mining took place after the coin was officially and publicly announced on <a href="https://bitcointalk.org/index.php?topic=1410943.0">Bitcointalk.org</a>.

<a href="#Table_of_Contents_Steemit__Inc">^</a>
## <span id="What_is_the_Steemit_Privacy_Policy">What is the Vox Privacy Policy?</span>
...
## <span id="How_can_I_keep_my_Steem_account_secure">How can I keep my VoxChain account secure?</span>
...
It is not recommended to share your password or keys with any third party site. Vox Inc. is developing a login application that can be used on third party VoxChain front ends.
...
**Posting key** - The posting key allows accounts to post, comment, edit, vote, resteem, and follow or mute other accounts. Most users should be logging into Vox every day with the posting key. You are more likely to have your password or key compromised the more you use it so a limited posting key exists to restrict the damage that a compromised account key would cause.

**Active key** - The active key is meant for more sensitive tasks such as transferring funds, power up/down transactions, converting VoxChain Dollars, voting for witnesses, updating profile details and avatar, and placing a market order. 
...
<a href="#Table_of_Contents_Security">^</a>
## <span id="Are_my_STEEM_and_Steem_Dollar_tokens_insured_in_the_event_of_a_hack_or_if_someone_takes_over_my_account">Are my STEEM and VoxChain Dollar tokens insured in the event of a hack or if someone takes over my account?</span>
...
Vox Inc. owns the default recovery account (@steem) for all users who sign up using Vox.community. Vox can identify users by their original email, Facebook, or Reddit logins that were used to signup via Vox.community.
...
## <span id="Are_the_Steem_blockchain_and_Steemit_com_code_open_source">Are the VoxChain blockchain and Vox.community code open-source?</span>

Yes. Both the VoxChain blockchain and Vox.community are open-source projects.

Developers should however avoid the use of the term "Vox" in their own products, and instead refer to the VoxChain Blockchain or VoxChain Platform. Vox refers to Vox.community, which is owned by Vox, Inc.

<a href="#Table_of_Contents_Developers">^</a>
## <span id="Is_there_a_Github_page_for_Steemit_com">Is there a Github page for Vox.community?</span>

https://github.com/steemit/condenser

<a href="#Table_of_Contents_Developers">^</a>
## <span id="Is_there_a_Github_page_for_the_Steem_blockchain">Is there a Github page for the VoxChain blockchain?</span>

https://github.com/steemit/steem

<a href="#Table_of_Contents_Developers">^</a>
## <span id="What_is_available_for_developers_interested_in_Steem_and_Steemit">What is available for developers interested in VoxChain and Vox?</span>

Many software engineers are currently leveraging the open-source code to build their applications on VoxChain. There are more than sixty so far.

This post from the user @fabien has more information about the VoxChain API:
...
## <span id="What_are_Steem_witnesses">What are VoxChain witnesses?</span>

The VoxChain blockchain requires a set of people to create blocks and uses a consensus mechanism called delegated proof of stake, or DPOS. The community elects 'witnesses' to act as the network's block producers and governance body. There are 20 full-time witnesses, producing a block every 63-second round. A 21st position is shared by backup witnesses, who are scheduled proportionally to the amount of stake-weighted community approval they have. Witnesses are compensated with STEEM Power for each block they create.

Vox leverages VoxChain because the founders of Vox believe VoxChain’s decentralized text content storage and governance model makes VoxChain an excellent platform for supporting the long term success of its social network and digital currency tokens.
...
## <span id="What_third_party_tools_are_there_for_Steemit">What third-party tools are there for Vox?</span>

https://steemprojects.com/

<a href="#Table_of_Contents_Miscellaneous">^</a>
## <span id="Is_there_an_official_Steemit_Facebook_page">Is there an official Vox Facebook page?</span>

https://www.facebook.com/steemit/

<a href="#Table_of_Contents_Miscellaneous">^</a>
## <span id="Is_there_an_official_Steemit_Twitter_account">Is there an official Vox Twitter account?</span>

https://twitter.com/steemit

<a href="#Table_of_Contents_Miscellaneous">^</a>
## <span id="What_is_the_Steem_Whitepaper_and_what_is_its_purpose">What is the VoxChain Whitepaper and what is its purpose?</span>

The VoxChain Whitepaper was written to describe the mechanics of the token system that makes decentralized content incentives and distribution possible in a way that can improve web technologies across the board. It is also applicable to Vox, the first website to plug into the VoxChain blockchain. Users who have read the VoxChain Whitepaper will better understand how their interactions with Vox are interactions with VoxChain, the decentralized network.

It is worth noting that the Whitepaper hasn’t been updated almost since VoxChain came into existence. Many changes have been made since then, so much of the Whitepaper is now out of date. It is in the process of being rewritten.
...
You can also create a post on Vox.community with the tag #help, and someone in the community may be able to answer it.
...
BlockTrades, Poloniex, Bittrex, Changelly, Shapeshift.io, Coinbase, Localbitcoins, SteemDB, PeerHub, Vox.chat, SteemTools, SteemCreate, AnonSteem, SteemConnect, Streemian, SteemStats, Pixabay, Steemcleaners, Pexels, Postimage, Markdown Cheatsheet, @cheetah, Bitcointalk, bitcoinfees, blockchain.info, and steemd are third party applications/services, and are not owned or maintained by Vox, Inc. Their listing here, as well as any other third party applications or websites that are listed, does not constitute and endorsement or recommendation on behalf of Vox, Inc.

All links to user posts were created by our users and do not necessarily represent the views of Vox, Inc. or its management. Their listing here does not constitute and endorsement or recommendation on behalf of Vox, Inc.
