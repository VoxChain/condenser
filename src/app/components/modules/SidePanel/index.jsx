    ...
    const sidePanelLinks = {
        ...
        external: [
            {
                ...
                link: 'https://developers.vox.community/',
            },
        ],
        organizational: [
            {
                ...
                link: 'https://vox.community/bluepaper.pdf',
            },
            {
                value: 'smt_whitepaper',
                label: tt('navigation.smt_whitepaper'),
                link: 'https://smt.vox.community/',
            },
            {
                value: 'whitepaper',
                label: tt('navigation.whitepaper'),
                link: 'https://vox.community/WhitePaper.pdf',
            },
            {
                value: 'about',
                label: tt('navigation.about'),
                link: 'https://vox.community',
            },
        ],
        legal: [
            {
        ...
        extras: [
            ...
            },
            {
                value: 'signup',
                label: tt('g.sign_up'),
                link: 'https://signup.next.vox.community',
            },
            {
                value: 'post',
                label: tt('g.post'),
