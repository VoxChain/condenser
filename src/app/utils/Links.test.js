...
describe('Links', () => {
    ...
    it('by domain', () => {
        const locals = [
            'https://localhost/',
            'http://next.vox.community',
            'http://next.vox.community/group',
        ];
        ...
        // match(linksRe({external: false}), largeData + 'https://next.vox.community2/next', 'https://next.vox.community2/next')
    });
    it('by image', () => {
